...
const headCells = [
  ...
  { id: 'partsAppName', numeric: true, disablePadding: false, label: 'Parts App Name' },
...
function PartsAdminTableHead(props) {
...
function PartsAdminTable(props) {
  ...
  const changeActive = (value, index) => {
    /* setLoading(true);
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <SelectControl
                        selectedValue={row.role || 'Active'}
                        valueList={GroupRoles}
                        onChangeValue={value => changeActive(value, index + rowsPerPage * page)}>
                      </SelectControl>
                    </TableCell>
                  </TableRow>
                );
